# `XDiag_jll.jl` (v0.3.2+0)

[![deps](https://juliahub.com/docs/XDiag_jll/deps.svg)](https://juliahub.com/ui/Packages/General/XDiag_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ebce50f111cfa4cba27f7c5ad1f1eb314d54812b/X/XDiag/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/awietek/xdiag.git (revision: `a92014fbd0f8aab455d0a1595812a9818785d243`)
