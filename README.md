# `XDiag_jll.jl` (v0.4.0+0)

[![deps](https://juliahub.com/docs/XDiag_jll/deps.svg)](https://juliahub.com/ui/Packages/General/XDiag_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/538047e552bdcddde4374e8f2b6183f066576104/X/XDiag/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/awietek/xdiag.git (revision: `f29365a99481d6a548d99a56bb5811f9e4f64948`)
