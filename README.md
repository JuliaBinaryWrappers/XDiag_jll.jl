# `XDiag_jll.jl` (v0.2.2+1)

[![deps](https://juliahub.com/docs/XDiag_jll/deps.svg)](https://juliahub.com/ui/Packages/General/XDiag_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/eb37a0167dc4c47032bb7792b2ddd10d1a920f98/X/XDiag/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/awietek/xdiag.git (revision: `9f3b148e8983a5c1e3186af76ee8628950bfd5ee`)
